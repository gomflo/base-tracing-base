...
export default function Home() {
  const [nodes, setNodes] = useState(errorNodes);
  const [edges, setEdges] = useState(errorEdges);
    ...
    <div className="bg-gray-50 h-full">
      ...
      <div className="flex mx-5 space-x-5 mt-12">
        <div>
          ...
          <div className="px-1 mt-4 flex space-x-4 items-center">
            <div className="flex flex-col space-y-1">
              <span className="text-xs text-gray-500 uppercase font-semibold px-0.5">
                Desde
              </span>
              <input
                type="datetime-local"
                value="2022-06-12T19:30"
                className="rounded-md bg-gray-200 border-none py-1.5 placeholder-gray-400 text-sm focus:outline-none focus:ring-1 focus:ring-gray-900 focus:border-none"
              />
            </div>
            <div className="flex flex-col space-y-1">
              <span className="text-xs text-gray-500 uppercase font-semibold px-0.5">
          ...
          <div className="bg-white rounded-lg shadow w-full">
            <ul className="mt-4 flex flex-col divide-y">
              ...
              <li>
                <Link href="/transactions/0001">
                  <a className="text-xs px-4 py-1.5 flex font-medium items-center justify-between text-gray-700 hover:bg-gray-100">
